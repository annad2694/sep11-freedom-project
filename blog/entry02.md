...
<p>However, I like my second attempt more, where I used Kaboom code, and it definitely has a cleaner and less complicated look to it because it does exactly what the other one did, but it waits one second. </p>
...
### EDP
<p>I believe that, as of late, I am most definitely in the <b>defining the problem</b> and <b>researching the problem</b> stage of the engineering design process. I feel like I have definitely run into a problem, and I have researched what the problem I encountered was. Over the break, I plan to <b>brainstorm possible solutions</b> to manage and fix the problem so I can get my code running more efficiently by the time I get back from break for the next Freedom Monday.</p>

---

### Skills
<p>Since my previous entry, I have practiced the skills of <b>how to Google</b> and have been using ⌘+F a lot to find specific things I need in <a href="https://kaboomjs.com/Q"> Kaboom.js </a> because there is a lot to read through, and it is much easier if I filter for what I specifically need. Another skill that I have been focusing on is <b>paying attention to detail</b> and making sure that the professionalism and syntax rules in everything that I code or write for this class are correct. I have realized that any small mistake can ruin the code, and I may never find what is bugging it later on, so I work slowly and make sure that everything is proper and spelled correctly.</p>
